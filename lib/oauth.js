...
exports.getImplicitAccessToken = (appCredentials) => {
    let authorizationPageUrl = `${appCredentials.auth_url}?client_id=${appCredentials.client_id}&respnose_type=token&scope=${appCredentials.scope}&redirect_uri=${appCredentials.redirect_uri}`;
